...
export default function UserSetup({ user, chapters }: UserSetupProps) {
    ...
    return (
        <div className="relative min-h-full">
            ...
            <div className="sticky top-0 h-[100dvh] flex items-center justify-center p-4 pointer-events-none">
                <div className="relative bg-white dark:bg-zinc-900 w-full max-w-lg p-8 border-4 border-red-600 shadow-2xl overflow-y-auto max-h-[90vh] pointer-events-auto">
