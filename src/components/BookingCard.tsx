...
export default function BookingCard({ b, requests, isAdmin = false }: BookingCardProps) {
    ...
    return (
        <div className={`bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 flex flex-col relative group overflow-hidden transition-all ${isPending && !isAdmin ? 'opacity-75 grayscale-[0.2]' : ''}`}>
            ...
            <div className="px-2 py-8 sm:p-8 space-y-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    {b.dates.map((date) => (
                        <div key={date.id} className="bg-white dark:bg-black px-2 py-6 sm:p-6 border border-zinc-200 dark:border-zinc-800 space-y-4 shadow-sm relative">
                ...
                {b.questions && (
                    <div className="bg-zinc-100 dark:bg-zinc-800/50 px-2 py-6 sm:p-6 border-l-4 border-zinc-300 dark:border-zinc-700">
