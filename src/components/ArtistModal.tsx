...
export default function ArtistModal({ artist, chapters, availableMusicians, currentUserId, onClose, pendingEdit }: ArtistModalProps) {
    ...
    return (
        <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4">
            <div className="bg-white dark:bg-zinc-900 w-full max-w-lg p-8 border border-zinc-200 dark:border-zinc-800 shadow-2xl relative overflow-y-auto max-h-[90vh]">
