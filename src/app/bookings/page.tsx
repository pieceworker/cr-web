            ...
            <div className={`col-start-1 row-start-1 py-12 px-2 sm:px-6 space-y-16 transition-all duration-700 ${!isAuthenticated ? 'blur-[1px] grayscale-[0.5]' : ''}`}>
                <section className="space-y-8">
                    <div className="space-y-2">
                        ...
                        <p className="text-zinc-500 font-medium italic">Ready to ditch the concert hall? From backyard gatherings to elegant private events, tell us what you&apos;re planning and we&apos;ll bring the music.</p>
                    </div>
                    <BookingForm
